...
export const metadata = {
  title: "Biz haqimizda | ObunaPro",
  description: "ObunaPro — premium obuna akkauntlari va litsenziyalar do‘koni haqida"
};
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">ObunaPro jamoasi va xizmatlarimiz haqida</p>
      </div>

      <section className="glass-card space-y-4 p-6">
        <h2 className="text-xl font-semibold text-foreground">ObunaPro nima?</h2>
        <p className="leading-relaxed text-foreground/90">
          ObunaPro — premium obuna akkauntlari va litsenziyalarni xavfsiz va tez yetkazib beruvchi platforma.
